...
defimpl Poison.Decoder, for: VRChat.Model.ApiConfig do
  ...
  def decode(value, options) do
    value
    |> deserialize(:announcements, :list, VRChat.Model.ApiConfigAnnouncement, options)
    |> deserialize(:deploymentGroup, :struct, VRChat.Model.DeploymentGroup, options)
    |> deserialize(:downloadUrls, :struct, VRChat.Model.ApiConfigDownloadUrlList, options)
    |> deserialize(:dynamicWorldRows, :list, VRChat.Model.DynamicContentRow, options)
    |> deserialize(:events, :struct, VRChat.Model.ApiConfigEvents, options)
  end
end
