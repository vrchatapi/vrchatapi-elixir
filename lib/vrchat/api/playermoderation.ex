...
defmodule VRChat.Playermoderation do
  @moduledoc """
  ...
  """
  @spec clear_all_player_moderations(Tesla.Env.client(), keyword()) ::
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_player_moderations(Tesla.Env.client(), keyword()) ::
          {:ok, list(VRChat.Model.PlayerModeration.t())}
          | {:ok, VRChat.Model.Error.t()}
          | {:error, Tesla.Env.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec moderate_user(Tesla.Env.client(), keyword()) ::
          {:ok, VRChat.Model.PlayerModeration.t()}
          | {:ok, VRChat.Model.Error.t()}
          | {:error, Tesla.Env.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec unmoderate_user(Tesla.Env.client(), keyword()) ::
          {:ok, VRChat.Model.Success.t()}
          | {:ok, VRChat.Model.Error.t()}
          | {:error, Tesla.Env.t()}
