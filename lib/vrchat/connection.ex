...
defmodule VRChat.Connection do
  ...
  Additional middleware can be set in the compile-time or runtime configuration:
      ...
      config :tesla, VRChat.Connection,
  ...
  - `options`: a keyword list of VRChat.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:vrchat, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - VRChat 1.11.1 - elixir"
        )
      )
